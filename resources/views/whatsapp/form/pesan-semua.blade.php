                ...
                <div class="row">
                    <div class="col">
                        <div class="list-group mb-3">
                            <div>
                                <input type="checkbox" wire:model="kirimKe" value="siswa" id="Kelas1" />
                                <label class="list-group-item" for="Kelas1">Siswa</label>
                            </div>
                        </div>
                        @error('kirimKe')
                            <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="col">
                        <div class="list-group mb-3">
                            <div>
                                <input type="checkbox" wire:model="kirimKe" value="ortu" id="Kelas2" />
                                <label class="list-group-item" for="Kelas2">Orang Tua/Wali</label>
                            </div>
                        </div>
                    </div>
                </div>
